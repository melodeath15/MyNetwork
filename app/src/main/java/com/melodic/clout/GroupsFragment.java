...
import com.melodic.clout.adapter.CommunityListAdapter;
...
public class GroupsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    private CommunityListAdapter itemsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            itemsAdapter = new CommunityListAdapter(getActivity(), itemsList);
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem menuItem = menu.findItem(R.id.action_managed_groups);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_managed_groups: {

                Intent i = new Intent(getActivity(), ManagedGroupsActivity.class);
                startActivity(i);
