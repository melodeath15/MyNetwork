...
public class PostShareDialog extends DialogFragment implements Constants {
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onPostRePost(position);
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        b.setTitle(getText(R.string.label_post_share));

        b.setMessage(getText(R.string.label_post_share_desc));
