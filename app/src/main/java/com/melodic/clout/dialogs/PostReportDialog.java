...
public class PostReportDialog  extends DialogFragment implements Constants {
    ...
    public interface AlertPositiveListener {
        ...
        public void onPostReport(int position, int reason);
    }
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onPostReport(position, reason);
        }
    };
