package com.melodic.clout.constants;
...
public interface Constants {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyCLPComiw10U6ME7cwswkXAtTW3-jKAhhA";
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgK";

    public static final String WEB_SITE = "http://216.200.116.43/";  //web site url address
    ...
    public static final String API_DOMAIN = "http://216.200.116.43/";  // url address to which the application sends requests
