...
import com.melodic.clout.adapter.PeopleListAdapter;
...
public class FollowingsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (!isAdded() || getActivity() == null) {
                            ...
                            Log.e("ERROR", "FollowingsFragment Not Added to Activity");
