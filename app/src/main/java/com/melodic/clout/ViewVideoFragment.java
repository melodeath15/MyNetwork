...
import com.melodic.clout.adapter.CommentListAdapter;
import com.melodic.clout.app.App;
import com.melodic.clout.constants.Constants;
import com.melodic.clout.dialogs.CommentActionDialog;
import com.melodic.clout.dialogs.CommentDeleteDialog;
import com.melodic.clout.dialogs.MyCommentActionDialog;
import com.melodic.clout.dialogs.MyPhotoActionDialog;
import com.melodic.clout.dialogs.PhotoActionDialog;
import com.melodic.clout.dialogs.PhotoDeleteDialog;
import com.melodic.clout.dialogs.PhotoReportDialog;
import com.melodic.clout.model.Comment;
import com.melodic.clout.model.Video;
import com.melodic.clout.util.Api;
import com.melodic.clout.util.CommentInterface;
import com.melodic.clout.util.CustomRequest;
import com.melodic.clout.view.ResizableImageView;


public class ViewVideoFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener, CommentInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mListViewHeader = getActivity().getLayoutInflater().inflate(R.layout.video_list_row, null);
        ...
        mVideoView = (VideoView) mListViewHeader.findViewById(R.id.videoView);
    ...
    public void updateItem() {
        ...
        mItemLike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (App.getInstance().isConnected()) {
                    ...
                    CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_VIDEO_LIKE, null,
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    if (!isAdded() || getActivity() == null) {
                                        ...
                                        Log.e("ERROR", "ViewVideoFragment Not Added to Activity");
        ...
        mItemLikesCount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("itemType", ITEM_TYPE_VIDEO);
                startActivity(intent);
            }
        });
    ...
    public void getItem() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_VIDEO_ITEM_GET, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                if (response.has("comments") && item.getFromUserAllowVideoComments() == 1) {
    ...
    public void send() {
        ...
        if (App.getInstance().isConnected() && App.getInstance().getId() != 0 && commentText.length() > 0) {
            ...
            CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_VIDEO_COMMENTS_NEW, null,
                    new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {
    ...
    public void onVideoDelete(final int position) {
        ...
        api.videoDelete(item.getId());

        getActivity().finish();
    }

    public void onVideoReport(int position, int reasonId) {

        if (App.getInstance().isConnected()) {

            Api api = new Api(getActivity());

            api.videoReport(item.getId(), reasonId);
    ...
    public void showContentScreen() {
        ...
        if (item.getFromUserAllowVideoComments() == COMMENTS_DISABLED) {
    ...
    public void onCommentReply(final int position) {
        ...
        if (item.getFromUserAllowVideoComments() == COMMENTS_ENABLED) {
    ...
    public void onCommentDelete(final int position) {
        ...
        api.videoCommentDelete(comment.getId());
    }
}